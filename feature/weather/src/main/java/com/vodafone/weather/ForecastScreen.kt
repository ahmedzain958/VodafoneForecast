...
import com.vodafone.a7days_forecast.ForecastListScreen
import com.vodafone.a7days_forecast.ForecastListViewModel
        ...
        Column(
            ...
            CityInputScreen(cityInputViewModel, onClick = { cityName ->
                if (previousCity != cityName) { // Only call when city changes
                    ...
                    forecastListViewModel.handleIntent(com.vodafone.a7days_forecast.ForecastListIntent.LoadForecast(cityName))
                }})
